...
<div class="container-fluid text-center">   
  <div class="row content">
    ...
    <div class="container">
  <h2>BOOKS</h2>
  <form class="form-horizontal" action="Book.jsp">
    <div class="form-group">
      <label class="control-label col-sm-2" for="o">Author</label>
      <div class="col-sm-2">
        <select class="form-control" >
              <option>Chethan Bhagat</option>
                <option>Grid Blyton</option>
  ...
  <form class="form-inline" action="Book.jsp">
      <div class="form-group">
